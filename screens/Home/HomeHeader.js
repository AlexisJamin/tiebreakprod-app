    ...
    return (
       ...
       <View style={{
        ...
        top:40
       		...
       		<TouchableWithoutFeedback hitSlop={{top: 30, left: 30, bottom: 30, right: 30}} onPress={() => this.props.navigation.navigate('Menu')}>
          ...
          </TouchableWithoutFeedback>
       {
        this.state.fontLoaded ? (<Text style={styles.title}> TIE BREAK </Text> ) : null 
           ...
           <IconBadge
            MainElement={
              <TouchableWithoutFeedback hitSlop={{top: 30, left: 30, bottom: 30, right: 30}} onPress={()=> this.navigationRoute('Chat',0)}>
